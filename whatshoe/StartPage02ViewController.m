...
#import "StartPage02ViewController.h"
#import "LeftSwipeSegue.h"
#import "RightSwipeSegue.h"

@interface StartPage02ViewController ()
@property (strong, nonatomic) IBOutlet UIImageView *pageImage;

@end

@implementation StartPage02ViewController
...
- (IBAction)leftSwipeAction:(UISwipeGestureRecognizer *)sender {
    ...
    UIViewController *mainViewController = [storyboard instantiateViewControllerWithIdentifier:@"Page01"];
