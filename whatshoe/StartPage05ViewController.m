...
#import "StartPage05ViewController.h"
#import "LeftSwipeSegue.h"
#import "RightSwipeSegue.h"

@interface StartPage05ViewController ()
@property (strong, nonatomic) IBOutlet UIImageView *pageImage;

@end

@implementation StartPage05ViewController
...
- (IBAction)leftSwipeAction:(UISwipeGestureRecognizer *)sender {
    ...
    UIViewController *mainViewController = [storyboard instantiateViewControllerWithIdentifier:@"Page04"];
